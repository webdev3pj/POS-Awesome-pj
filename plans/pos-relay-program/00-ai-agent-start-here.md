...
Implement `Phase 1`: Sales Associate token creation as a submitted `Sales Order` (online-first), with token slip print containing customer, SA name, date/time, total, QR, barcode, and token last4.
